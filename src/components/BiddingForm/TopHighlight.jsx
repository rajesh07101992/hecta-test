    ...
    <>
      <div className='bgWhite borderGray stickySection'>
        <div className='markBox'>
          <div id="one">
            <Tick width={16} />
            <p className='navLabel' style={{ marginLeft: '-30px', marginTop: '8px' }}
          ...
          <div className={biddersData ? 'progressLineFilled' : 'progressLineDashed'}>
          </div>
          
          <div>
            {kycData ? (<Tick width={16} />) : (<YellowMark width={16} />)}

            <p className='navLabel' style={{ marginLeft: '-40px', marginTop: '8px' }}
              onClick={handleClick(`#${props.kycDetailsId}`)}
            >
              KYC Documents
            </p>
          </div>
          <div className={ kycData ? 'progressLineFilled' : 'progressLineDashed'}>
          </div>
          <div>
            { emdData ? (<Tick width={16} />) : (<Cross width={16} />)}
          ...
          <div className={emdData ? 'progressLineFilled' : 'progressLineDashed'}>
          </div>
          <div>
            {termsData ? (<Tick width={16} />) : (<EmptyCircle width={16} />)}

            <p className='navLabel' style={{ marginLeft: '-50px', marginTop: '8px' }}
